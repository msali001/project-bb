    ...
    <div class="container">
        <form method="post" action="update_mul.php">
            <table class='table table-bordered'>
                ...
                {
                    $id = $chk[$i];
                    $res=$MySQLi_CON->query("SELECT * FROM bloodunits WHERE id=".$id);
                    while($row=$res->fetch_array())
                    {
                        ...
                        <tr>
                            <td>
                                ...
                                <input name="bg[]" value="<?php echo $row['bloodgroup'];?>" readonly="readonly" class="form-control"/>
                            </td>
                            <td>
                                <input type="number" name="un[]" value="<?php echo $row['units'];?>" class="form-control" />
                            </td>
                            <td>
                                <input type="text" name="camp[]" value="<?php echo $row['camp'];?>" class="form-control"/>
                            </td>
                            <td>
                                <input type="date" name="ddate[]" value="<?php echo $row['ddate'];?>" class="form-control"/>
                            </td>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="manageblood.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Cancel</a>
                    </td>
                </tr>
            </table>
        </form>
