...
$t=mysqli_query($MySQLi_CON,"select * from bloodunits ORDER BY id DESC");
...
$query=mysqli_query($MySQLi_CON,"select * from bloodunits ORDER BY id DESC limit $start,$limit");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="container">
        <form method="post" name="frm">
            <table class='table table-bordered table-responsive'>
                ...
                <?php
                $res = $MySQLi_CON->query("SELECT * FROM bloodunits ORDER BY id ASC");
                $count = $res->num_rows;
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <label style="margin-left:100px;">
                                ...
                                <span><img src="edit.png" onClick="edit_blood();" alt="edit" />&nbsp;&nbsp;</span>
                                <span><img src="delete.png" onClick="delete_blood();" alt="delete" />&nbsp;</span>
                            </label>
