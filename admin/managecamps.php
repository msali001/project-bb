...
$query=mysqli_query($MySQLi_CON,"select * from camps ORDER BY id DESC limit $start,$limit");
?>
...
if($count > 0)
{
    ...
    <span><img src="edit.png" onClick="edit_camp();" alt="edit" />&nbsp;&nbsp;</span>
    <span><img src="delete.png" onclick="delete_camp();"  alt="delete" />&nbsp;</span>
    </label>
