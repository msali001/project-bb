...
<section class="engine"><a rel="external" href="index">top responsive site design software</a></section><section class="mbr-section mbr-after-navbar" id="msg-box3-10" style="background-color: rgb(242, 242, 242); padding-top: 120px; padding-bottom: 45px;">
            ...
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div class="lead">
                    <form action="search_result.php" id="search_form" method="GET">
                        <input name="q" autocomplete="on" id="list_search" type="search" placeholder="Enter donor/recipient email address or phone number ... " required class="form-control" />
                        <button type="submit"  style="border:0px; margin-top: 25px;  width:150px; height:36px; border-radius: 10px;  box-shadow:1px 1px 5px black; color:white; font-weight: 600; font-size:18px; background-color:#D50000;">Search</button>
                    </form>
