...
<section class="engine"><a rel="external" href="index">easy website design</a></section><section class="mbr-section mbr-after-navbar" id="msg-box3-13" style="background-color: rgb(242, 242, 242); padding-top: 120px; padding-bottom: 120px;">

    
   <a href="viewusers.php" class="btn btn-large btn-info"><i class="glyphicon glyphicon-eye-open"></i> &nbsp; View Users</a>
</div>
...
<tr>
<td>Enter how many rows you want to insert</td>
</tr>

<tr>
<td>
<input type="text" name="no_of_rec" placeholder="how many rows u want to enter ? ex : 1 , 2 , 3 , 5" maxlength="2" pattern="[0-9]+" class="form-control" required />
</td>
</tr>
...
<a href="viewusers.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Back to View Users</a>
</td>
</tr>
