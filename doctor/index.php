        ...
        <div class="container">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
					...
					<li class="nav-item dropdown"><a class="nav-link link dropdown-toggle" href="#" data-toggle="dropdown-submenu" aria-expanded="false">HELP</a><div class="dropdown-menu"><a class="dropdown-item" href="../contact">CONTACT US</a><a class="dropdown-item" href="../faqs">FAQS</a></div></li></ul>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 class="mbr-section-title display-2">Log in </h3>
                      ...
                      <tr><td class="lefttd">E-Mail</td><td>: <input class="text-input" type="email" name="email" required="required" /></td></tr>
					  <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
                      <tr><td class="lefttd">Password</td><td>: <input class="text-input" type="password" name="password" required="required" pattern="[a-zA-Z0-9]{2,10}" title="please enter only character or numbers between 2 to 10 for password" /></td></tr>
					  <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
                <tr><td>&nbsp;</td><td><input type="submit" value="Sign In "  name="btn-login" 
				style="border:0px;  width:150px; height:40px; border-radius: 10px;  box-shadow:1px 1px 5px black; color:white;
