...
$t=mysqli_query($MySQLi_CON,"select * from requests ORDER BY reqdate DESC");
...
$query=mysqli_query($MySQLi_CON,"select * from requests ORDER BY reqdate DESC limit $start,$limit");
?>
