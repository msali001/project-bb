            ...
            <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
                ...
                if(isset($_POST['btn-request'])) {
                    ...
                    $count = $check_email->num_rows;
                     ...
                     $check_code = $MySQLi_CON->query("SELECT code FROM doctorregister WHERE code ='$code'");
                    $count2 = $check_code->num_rows;


                    if (($count == 0)&& ($count2 == 1)) {
                    	echo "'$fname','$lname','$email','$mobile','$b_id','$reqdate','$status','$units','$code'";
                        $updateQuery1 = "INSERT INTO requests (fname,lname,email,mobile,b_id,reqdate,status,units,code)
	VALUES('$fname','$lname','$email','$mobile','$b_id','$reqdate','$status','$units','$code')";
					...
					Request Sent Successfully please wait a few seconds to be redirected to your Account
                        ...
                        $msg1 = "<div class='alert bg-info'>
				<button class='close' data-dismiss='alert'>&times;</button>
					<strong>Sorry !</strong>Oh Snap The doctor code is invalid or you had requested earlier
			  </div>
			  ";
                ...
                <div class="lead">
                    ...
                    <form method="post">
                        <table cellpadding="0" cellspacing="0" width="100%"  class="tableborder" style="margin:auto" >
                            ...
                            <tr>
                                <td class="lefttd">Doctor Code</td>
                            </tr>
                            <tr>
                                <td><input class="text-input" style="color: red;" type="text" name="code" required="required" /></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
