...
<section class="engine"><a rel="external" href="#">html website development</a></section><section class="mbr-section mbr-after-navbar" id="msg-box3-x" style="background-color: rgb(242, 242, 242); padding-top: 120px; padding-bottom: 120px;">
  ...
  <div class="container">
    <div class="col-md-12">
      <div class="col-md-8 col-md-offset-2">
          ...
          <div class="col-md-8 col-md-offset-2 form-group">
            ...
            <div class="col-md-12">
		        <div class="col-md-3 col-sm-6 ">
				   <select class="form-control login-field" name="group" id="login-form" required >
				    <option value="">Group</option>
				    <option class="text-xs-center" value="A+ve">A+ve</option>
				    <option class="text-xs-center" value="A-ve">A-ve</option>
				    <option class="text-xs-center" value="B+ve">B+ve</option>
				    <option class="text-xs-center" value="B-ve">B-ve</option>
				    <option class="text-xs-center" value="AB+ve">AB+ve</option>
				    <option class="text-xs-center" value="AB-ve">AB-ve</option>
				    <option class="text-xs-center" value="O+ve">O+ve</option>
				    <option class="text-xs-center" value="O-ve">O-ve</option>
				  </select>
				      <span class="help-block" id="error"></span>
		      	</div>
        ...
        <div class="col-md-8 col-md-offset-2 form-group">
                ...
                <select name="county" class="form-control" required>
                   <option class="text-xs-center">Select District</option>
                   <option class="text-xs-center" value="Palakkad">Palakkad</option>
                   <option class="text-xs-center" value="Thrissur">Thrissur</option>
                   <option class="text-xs-center" value="Malappuram">Malappuram</option>
                   <option class="text-xs-center" value="Kozhikode">Kozhikode</option>
                   <option class="text-xs-center" value="Wayanad">Wayanad</option>
                   <option class="text-xs-center" value="Kannur">Kannur</option>
                   <option class="text-xs-center" value="Kazargode">Kazargode</option>
                   <option class="text-xs-center" value="Thiravanathapuram">Thiravanathapuram</option>
                   <option class="text-xs-center" value="Kollam">Kollam</option>
                   <option class="text-xs-center" value="Kottayam">Kottayam</option>
                   <option class="text-xs-center" value="Alapuzha">Alapuzha</option>
                   <option class="text-xs-center" value="Eranankulam">Eranankulam</option>
                   <option class="text-xs-center" value="Idukki">Idukki</option>
                   <option class="text-xs-center" value="Pathanamthitta">Pathanamthitta</option>
               </select>
      ...
      <section class="mbr-section mbr-section-md-padding mbr-footer footer1" id="contacts1-r" style="background-color: rgb(190, 22, 22); padding-top: 60px; padding-bottom: 40px;">
